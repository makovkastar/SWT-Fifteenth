...
public class SquareButton extends Canvas {
	...
	protected void setDefaultColors () {
		fontColor = getSavedColor(255, 255, 255);
		hoverFontColor = getSavedColor(255, 255, 255);
		clickedFontColor = getSavedColor(255, 255, 255);
		inactiveFontColor = getSavedColor(255, 255, 255);
		selectedFontColor = getSavedColor(255, 255, 255);
		borderColor = getSavedColor(255, 255, 255);
		hoverBorderColor = getSavedColor(255, 255, 255);
		clickedBorderColor = getSavedColor(255, 255, 255);
		inactiveBorderColor = getSavedColor(255, 255, 255);
		selectedBorderColor = getSavedColor(255, 255, 255);
		backgroundColor = getSavedColor(255, 255, 255);
		backgroundColor2 = getSavedColor(255, 255, 255);
		clickedColor = getSavedColor(255, 255, 255);
		clickedColor2 = getSavedColor(255, 255, 255);
		hoverColor = getSavedColor(255, 255, 255);
		hoverColor2 = getSavedColor(255, 255, 255);
		inactiveColor = getSavedColor(248, 248, 248);
		inactiveColor2 = getSavedColor(248, 248, 248);
		selectedColor = getSavedColor(248, 248, 248);
		selectedColor2 = getSavedColor(248, 248, 248);
	}
	...
	protected void setNormalColor (Event e) {
		setMouseEventColor(backgroundColor, backgroundColor, borderColor, fontColor);
	}
	...
	private void paintControl(PaintEvent e) {
		...
		Point p = this.computeSize(SWT.DEFAULT, SWT.DEFAULT, true);
